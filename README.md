...
-- FUNÇÕES PROBLEMÁTICAS OFF POR PADRÃO
-- ============================================
    ...
    for _, enemy in ipairs(enemies) do
        ...
        if rootVis or headVis then
            ...
            if Config.ESPHealthBar then
                ...
                -- Preenchimento da barra (cor dinâmica)
...
-- (aqui começam as funções createToggle, createSlider, etc.)
...
local function createDropdown(parent, y, text, var, options, default)
    ...
    btn.Position = UDim2.new(0.6, -60, 0.5, -15)
...
local function createKeybind(parent, y, text, var, default)
    ...
    btn.Position = UDim2.new(0.6, -60, 0.5, -15)
    btn.BackgroundColor3 = Colors.Inactive
    btn.Text = default.Name or default
    btn.TextColor3 = Colors.Text
    btn.TextSize = 14
    btn.Font = Enum.Font.GothamBold
    btn.BorderSizePixel = 0
...
local function CreateUI()
    ...
    version.Text = "v7.5.0 • FUNÇÕES PROBLEMÁTICAS OFF • ectorstuffo"
    ...
    visualTitle.TextColor3 = Colors.TextDim
    ...
    y = y + createToggle(contentFrame, y, "⚪ Hitbox (pode causar bolinhas)", "ShowHitbox", false)
    y = y + 5
    ...
    y = y + 5
    y = y + createToggle(contentFrame, y, "🧭 Direção (pode causar)", "ShowDirection", false)
    y = y + 5
    ...
    espTitle.Text = "👁️ ESP"
    espTitle.TextColor3 = Colors.TextDim
    ...
    if Config.ESPActive then
        ...
        y = y + 5
        y = y + createToggle(contentFrame, y, "Barra de Vida (causa bolinhas)", "ESPHealthBar", false)
        y = y + 5
    ...
    extrasTitle.TextColor3 = Colors.TextDim
    extrasTitle.TextSize = 18
...
-- ========== INICIAR ==========
CreateUI()
Notify("ZK HUB v7.5 • FUNÇÕES PROBLEMÁTICAS OFF")
